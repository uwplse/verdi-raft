...
set :format_options, command_output: true, log_file: "extraction/vard/log/capistrano.log", color: :auto, truncate: :auto
...
append :linked_dirs, "extraction/vard/tmp", "extraction/vard/log"
